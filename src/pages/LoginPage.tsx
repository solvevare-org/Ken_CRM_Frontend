      ...
      <div className="space-y-8">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input type="checkbox" className="rounded border-gray-300 bg-white text-black focus:ring-black/30" />
              <span className="text-black">Remember me</span>
            </label>
            <button type="button" className="text-black hover:text-black font-medium transition-colors">
              Forgot password?
            </button>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white text-black font-medium">or continue with</span>
          </div>
        </div>
        ...
        {/* Features Preview */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12 pt-8 border-t border-gray-300">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-black">Blazing fast performance</p>
          </div>
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-black">Smart automation</p>
          </div>
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-black">Bank-grade security</p>
          </div>
        </div>
      </div>
    </PageLayout>
